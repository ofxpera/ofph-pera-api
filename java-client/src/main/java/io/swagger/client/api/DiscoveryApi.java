...
public class DiscoveryApi {
    ...
    /**
     * Retrieve JSON Web Key Set (JWKS) containing public keys for JWT signature verification (configurable endpoint) (asynchronously)
     * Returns the public keys used to verify JWT signatures
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse2004 getOpenIdConfiguration() throws ApiException {
        ApiResponse<InlineResponse2004> resp = getOpenIdConfigurationWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2004> getOpenIdConfigurationWithHttpInfo() throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getOpenIdConfigurationAsync(final ApiCallback<InlineResponse2004> callback) throws ApiException {
    ...
    /**
     * Dynamic Client Registration (configurable endpoint) (asynchronously)
     * Register a new OFxPERA Participant as an OAuth client following FAPI Dynamic Client Registration requirements.
     * @param body  (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Update Client Registration (configurable endpoint) (asynchronously)
     * 
     * @param body  (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
