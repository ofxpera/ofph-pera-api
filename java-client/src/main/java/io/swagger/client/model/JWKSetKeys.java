...
public class JWKSetKeys {
  ...
  public enum KtyEnum {
    ...
    public static KtyEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<KtyEnum> {
      ...
      public KtyEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return KtyEnum.fromValue((String)(value));
      }
    }
  }  @SerializedName("kty")
  ...
  public enum CrvEnum {
    @SerializedName("P-256")
    _256("P-256"),
    @SerializedName("P-384")
    _384("P-384"),
    @SerializedName("P-521")
    _521("P-521");
    ...
    public static CrvEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<CrvEnum> {
      ...
      public CrvEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return CrvEnum.fromValue((String)(value));
      }
    }
  }  @SerializedName("crv")
