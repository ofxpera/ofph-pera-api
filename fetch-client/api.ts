...
const BASE_PATH = "https://virtserver.swaggerhub.com/maya-ph/OFxPERA-API/0.0.5".replace(/\/+$/, "");
...
export interface InlineResponse2001 {
     ...
     * @memberof InlineResponse2001
     */
    tokenType: InlineResponse2001.TokenTypeEnum;
    /**
...
export interface InlineResponse2006Results {
     ...
     * @memberof InlineResponse2006Results
     */
    status: InlineResponse2006Results.StatusEnum;
    /**
     * 
     * @type {BulkConsentResponseError}
     * @memberof InlineResponse2006Results
...
/**
 * @export
 * @namespace InlineResponse2006Results
 */
export namespace InlineResponse2006Results {
    /**
     * @export
     * @enum {string}
     */
...
export const BootstrapApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getParticipant(participantId: string, options: any = {}): FetchArgs {
         ...
         * @throws {RequiredError}
         */
        listParticipants(options: any = {}): FetchArgs {
         ...
         * @throws {RequiredError}
         */
        listProductByParticipant(participantId: string, options: any = {}): FetchArgs {
            // verify required parameter 'participantId' is not null or undefined
            if (participantId === null || participantId === undefined) {
            ...
            const localVarPath = `/ofxpera/product/{participant_id}`
                .replace(`{${"participant_id"}}`, encodeURIComponent(String(participantId)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
         ...
         * @throws {RequiredError}
         */
        registerParticipant(body: ParticipantConfig, options: any = {}): FetchArgs {
         ...
         * @throws {RequiredError}
         */
        registerProduct(options: any = {}): FetchArgs {
            const localVarPath = `/ofxpera/product`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
         ...
         * @throws {RequiredError}
         */
        updateParticipant(body: ParticipantConfig, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
         ...
         * @throws {RequiredError}
         */
        updateProduct(productId: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/ofxpera/product/{product_id}`
...
export const BootstrapApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getParticipant(participantId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ParticipantConfig> {
            const localVarFetchArgs = BootstrapApiFetchParamCreator(configuration).getParticipant(participantId, options);
         ...
         * @throws {RequiredError}
         */
        listParticipants(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<ParticipantConfig>> {
            const localVarFetchArgs = BootstrapApiFetchParamCreator(configuration).listParticipants(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        listProductByParticipant(participantId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<PeraProduct>> {
            const localVarFetchArgs = BootstrapApiFetchParamCreator(configuration).listProductByParticipant(participantId, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        registerParticipant(body: ParticipantConfig, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ClientRegistrationResponse> {
            const localVarFetchArgs = BootstrapApiFetchParamCreator(configuration).registerParticipant(body, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        registerProduct(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PeraProduct> {
            const localVarFetchArgs = BootstrapApiFetchParamCreator(configuration).registerProduct(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        updateParticipant(body: ParticipantConfig, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ClientRegistrationResponse> {
            const localVarFetchArgs = BootstrapApiFetchParamCreator(configuration).updateParticipant(body, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        updateProduct(productId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PeraProduct> {
            const localVarFetchArgs = BootstrapApiFetchParamCreator(configuration).updateProduct(productId, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const BootstrapApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        getParticipant(participantId: string, options?: any) {
            return BootstrapApiFp(configuration).getParticipant(participantId, options)(fetch, basePath);
        },
        /**
         * API for retrieving all registered OFxPERA Participants
         * @summary Get a list of registered OFxPERA Participants
         ...
         * @throws {RequiredError}
         */
        listParticipants(options?: any) {
            return BootstrapApiFp(configuration).listParticipants(options)(fetch, basePath);
        },
        /**
         * API for retrieving all registered products associated with the PERA Admin.
         * @summary Get a list of PERA products associated with PERA Admin
         ...
         * @throws {RequiredError}
         */
        listProductByParticipant(participantId: string, options?: any) {
            return BootstrapApiFp(configuration).listProductByParticipant(participantId, options)(fetch, basePath);
        },
        /**
         * API for registering an OFxPERA Participant following FAPI Dynamic Client Registration requirements
         * @summary Register an OFxPERA Participant
         ...
         * @throws {RequiredError}
         */
        registerParticipant(body: ParticipantConfig, options?: any) {
            return BootstrapApiFp(configuration).registerParticipant(body, options)(fetch, basePath);
        },
        /**
         * API that allows PERA Admin to register a PERA product.
         * @summary Register a PERA Admin Product
         ...
         * @throws {RequiredError}
         */
        registerProduct(options?: any) {
            return BootstrapApiFp(configuration).registerProduct(options)(fetch, basePath);
        },
        /**
         * API for updating the URIs and status of an OFxPERA Participant
         * @summary Update an OFxPERA Participant
         ...
         * @throws {RequiredError}
         */
        updateParticipant(body: ParticipantConfig, options?: any) {
            return BootstrapApiFp(configuration).updateParticipant(body, options)(fetch, basePath);
        },
        /**
         * API that allows PERA Admin to update their product.
         * @summary Update a PERA Admin Product
         ...
         * @throws {RequiredError}
         */
        updateProduct(productId: string, options?: any) {
            return BootstrapApiFp(configuration).updateProduct(productId, options)(fetch, basePath);
        },
    };
};
...
export class BootstrapApi extends BaseAPI {
     ...
     */
    public getParticipant(participantId: string, options?: any) {
        return BootstrapApiFp(this.configuration).getParticipant(participantId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof BootstrapApi
     */
    public listParticipants(options?: any) {
        return BootstrapApiFp(this.configuration).listParticipants(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof BootstrapApi
     */
    public listProductByParticipant(participantId: string, options?: any) {
        return BootstrapApiFp(this.configuration).listProductByParticipant(participantId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof BootstrapApi
     */
    public registerParticipant(body: ParticipantConfig, options?: any) {
        return BootstrapApiFp(this.configuration).registerParticipant(body, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof BootstrapApi
     */
    public registerProduct(options?: any) {
        return BootstrapApiFp(this.configuration).registerProduct(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof BootstrapApi
     */
    public updateParticipant(body: ParticipantConfig, options?: any) {
        return BootstrapApiFp(this.configuration).updateParticipant(body, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof BootstrapApi
     */
    public updateProduct(productId: string, options?: any) {
        return BootstrapApiFp(this.configuration).updateProduct(productId, options)(this.fetch, this.basePath);
    }
...
export const CommonApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        forwardCustomerEndorsement(endorsement: string, options: any = {}): FetchArgs {
         ...
         * @throws {RequiredError}
         */
        getCustomerDetail(customerId: string, options: any = {}): FetchArgs {
...
export const CommonApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        forwardCustomerEndorsement(endorsement: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<EndorsementResponse> {
            const localVarFetchArgs = CommonApiFetchParamCreator(configuration).forwardCustomerEndorsement(endorsement, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getCustomerDetail(customerId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<CustomerInformation> {
            const localVarFetchArgs = CommonApiFetchParamCreator(configuration).getCustomerDetail(customerId, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const CommonApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        forwardCustomerEndorsement(endorsement: string, options?: any) {
            return CommonApiFp(configuration).forwardCustomerEndorsement(endorsement, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get detailed customer information
         ...
         * @throws {RequiredError}
         */
        getCustomerDetail(customerId: string, options?: any) {
            return CommonApiFp(configuration).getCustomerDetail(customerId, options)(fetch, basePath);
        },
    };
};
...
export class CommonApi extends BaseAPI {
     ...
     * @memberof CommonApi
     */
    public forwardCustomerEndorsement(endorsement: string, options?: any) {
        return CommonApiFp(this.configuration).forwardCustomerEndorsement(endorsement, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof CommonApi
     */
    public getCustomerDetail(customerId: string, options?: any) {
        return CommonApiFp(this.configuration).getCustomerDetail(customerId, options)(this.fetch, this.basePath);
    }
...
export const ConsentApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        bulkUpdateCustomerConsents(body: ArrangementsBulkupdateBody, customerId: string, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
         ...
         * @throws {RequiredError}
         */
        createBulkConsent(body: BulkConsentRequest, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
         ...
         * @throws {RequiredError}
         */
        createConsentArrangement(body: ConsentArrangementRequest, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
         ...
         * @throws {RequiredError}
         */
        extendConsentDuration(body: ConsentExtensionRequest, arrangementId: string, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
         ...
         * @throws {RequiredError}
         */
        getConsentArrangement(arrangementId: string, options: any = {}): FetchArgs {
            // verify required parameter 'arrangementId' is not null or undefined
            if (arrangementId === null || arrangementId === undefined) {
         ...
         * @throws {RequiredError}
         */
        getConsentHistory(arrangementId: string, options: any = {}): FetchArgs {
            // verify required parameter 'arrangementId' is not null or undefined
            if (arrangementId === null || arrangementId === undefined) {
         ...
         * @throws {RequiredError}
         */
        getCustomerConsentDashboard(customerId: string, options: any = {}): FetchArgs {
            // verify required parameter 'customerId' is not null or undefined
            if (customerId === null || customerId === undefined) {
         ...
         * @throws {RequiredError}
         */
        getCustomerConsents(customerId: string, status?: string, dataHolderId?: string, purpose?: string, options: any = {}): FetchArgs {
            // verify required parameter 'customerId' is not null or undefined
            if (customerId === null || customerId === undefined) {
         ...
         * @throws {RequiredError}
         */
        listConsentArrangements(status?: string, fromDate?: Date, toDate?: Date, options: any = {}): FetchArgs {
            const localVarPath = `/consent/arrangements`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
         ...
         * @throws {RequiredError}
         */
        listConsentTemplates(category?: string, purpose?: string, options: any = {}): FetchArgs {
         ...
         * @throws {RequiredError}
         */
        revokeConsentArrangement(arrangementId: string, options: any = {}): FetchArgs {
            // verify required parameter 'arrangementId' is not null or undefined
            if (arrangementId === null || arrangementId === undefined) {
         ...
         * @throws {RequiredError}
         */
        updateConsentStatus(body: ConsentStatusUpdate, arrangementId: string, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
...
export const ConsentApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        bulkUpdateCustomerConsents(body: ArrangementsBulkupdateBody, customerId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse2006> {
            const localVarFetchArgs = ConsentApiFetchParamCreator(configuration).bulkUpdateCustomerConsents(body, customerId, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        createBulkConsent(body: BulkConsentRequest, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<BulkConsentResponse> {
            const localVarFetchArgs = ConsentApiFetchParamCreator(configuration).createBulkConsent(body, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        createConsentArrangement(body: ConsentArrangementRequest, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ConsentArrangementResponse> {
            const localVarFetchArgs = ConsentApiFetchParamCreator(configuration).createConsentArrangement(body, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        extendConsentDuration(body: ConsentExtensionRequest, arrangementId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ConsentArrangementResponse> {
            const localVarFetchArgs = ConsentApiFetchParamCreator(configuration).extendConsentDuration(body, arrangementId, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getConsentArrangement(arrangementId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ConsentArrangementResponse> {
            const localVarFetchArgs = ConsentApiFetchParamCreator(configuration).getConsentArrangement(arrangementId, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getConsentHistory(arrangementId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ConsentHistory> {
            const localVarFetchArgs = ConsentApiFetchParamCreator(configuration).getConsentHistory(arrangementId, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getCustomerConsentDashboard(customerId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ConsentDashboard> {
            const localVarFetchArgs = ConsentApiFetchParamCreator(configuration).getCustomerConsentDashboard(customerId, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getCustomerConsents(customerId: string, status?: string, dataHolderId?: string, purpose?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse2005> {
            const localVarFetchArgs = ConsentApiFetchParamCreator(configuration).getCustomerConsents(customerId, status, dataHolderId, purpose, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        listConsentArrangements(status?: string, fromDate?: Date, toDate?: Date, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<ConsentArrangementResponse>> {
            const localVarFetchArgs = ConsentApiFetchParamCreator(configuration).listConsentArrangements(status, fromDate, toDate, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        listConsentTemplates(category?: string, purpose?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<ConsentTemplate>> {
            const localVarFetchArgs = ConsentApiFetchParamCreator(configuration).listConsentTemplates(category, purpose, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        revokeConsentArrangement(arrangementId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = ConsentApiFetchParamCreator(configuration).revokeConsentArrangement(arrangementId, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
         ...
         * @throws {RequiredError}
         */
        updateConsentStatus(body: ConsentStatusUpdate, arrangementId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ConsentArrangementResponse> {
            const localVarFetchArgs = ConsentApiFetchParamCreator(configuration).updateConsentStatus(body, arrangementId, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const ConsentApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        bulkUpdateCustomerConsents(body: ArrangementsBulkupdateBody, customerId: string, options?: any) {
            return ConsentApiFp(configuration).bulkUpdateCustomerConsents(body, customerId, options)(fetch, basePath);
        },
        /**
         * Create multiple consent arrangements in a single request. Based on: - Korea MyData Bulk Consent API - Singapore SGFinDex Multi-Institution Consent 
         * @summary Create bulk consent arrangements
         ...
         * @throws {RequiredError}
         */
        createBulkConsent(body: BulkConsentRequest, options?: any) {
            return ConsentApiFp(configuration).createBulkConsent(body, options)(fetch, basePath);
        },
        /**
         * Create a new consent arrangement between a data holder and data recipient. Based on: - UK Open Banking Consent API v3.1.10 - Australia CDR Consent Management Standards v1.14.0 - Singapore SGFinDex Consent Framework 
         * @summary Create a consent arrangement
         ...
         * @throws {RequiredError}
         */
        createConsentArrangement(body: ConsentArrangementRequest, options?: any) {
            return ConsentApiFp(configuration).createConsentArrangement(body, options)(fetch, basePath);
        },
        /**
         * Extend the duration of an existing consent arrangement. Based on: - Australia CDR Consent Amendment - UK Open Banking Re-authentication 
         * @summary Extend consent arrangement duration
         ...
         * @throws {RequiredError}
         */
        extendConsentDuration(body: ConsentExtensionRequest, arrangementId: string, options?: any) {
            return ConsentApiFp(configuration).extendConsentDuration(body, arrangementId, options)(fetch, basePath);
        },
        /**
         * Retrieve details of a specific consent arrangement. Based on: - UK Open Banking Account Access Consents API - Australia CDR Get Consent API 
         * @summary Get consent arrangement details
         ...
         * @throws {RequiredError}
         */
        getConsentArrangement(arrangementId: string, options?: any) {
            return ConsentApiFp(configuration).getConsentArrangement(arrangementId, options)(fetch, basePath);
        },
        /**
         * Retrieve the full history of changes to a consent arrangement. Based on: - Australia CDR Consent History API - UK Open Banking Consent Audit Requirements 
         * @summary Get consent arrangement history
         ...
         * @throws {RequiredError}
         */
        getConsentHistory(arrangementId: string, options?: any) {
            return ConsentApiFp(configuration).getConsentHistory(arrangementId, options)(fetch, basePath);
        },
        /**
         * Retrieve a comprehensive view of customer's consent arrangements and data sharing. Based on: - Australia CDR Consumer Dashboard - UK Open Banking Consent Dashboard - Singapore SGFinDex Customer Portal 
         * @summary Get customer's consent dashboard
         ...
         * @throws {RequiredError}
         */
        getCustomerConsentDashboard(customerId: string, options?: any) {
            return ConsentApiFp(configuration).getCustomerConsentDashboard(customerId, options)(fetch, basePath);
        },
        /**
         * Retrieve all consent arrangements for a specific customer. Based on: - UK Open Banking Customer Consent Management - Australia CDR Consumer Dashboard APIs - Singapore SGFinDex Customer Consent View 
         * @summary Get customer's consent arrangements
         ...
         * @throws {RequiredError}
         */
        getCustomerConsents(customerId: string, status?: string, dataHolderId?: string, purpose?: string, options?: any) {
            return ConsentApiFp(configuration).getCustomerConsents(customerId, status, dataHolderId, purpose, options)(fetch, basePath);
        },
        /**
         * Retrieve a list of active consent arrangements for the authenticated user. Based on: - UK Open Banking Account Access Consents API - Australia CDR Get Consent API 
         * @summary List consent arrangements
         ...
         * @throws {RequiredError}
         */
        listConsentArrangements(status?: string, fromDate?: Date, toDate?: Date, options?: any) {
            return ConsentApiFp(configuration).listConsentArrangements(status, fromDate, toDate, options)(fetch, basePath);
        },
        /**
         * Retrieve available consent templates that can be used to create new arrangements. Based on: - Australia CDR Consent Taxonomy - UK Open Banking Standard Permissions 
         * @summary List available consent templates
         ...
         * @throws {RequiredError}
         */
        listConsentTemplates(category?: string, purpose?: string, options?: any) {
            return ConsentApiFp(configuration).listConsentTemplates(category, purpose, options)(fetch, basePath);
        },
        /**
         * Revoke an existing consent arrangement. Based on: - UK Open Banking Account Access Consents API - Australia CDR Revoke Consent API - Korea MyData Consent Revocation API 
         * @summary Revoke consent arrangement
         ...
         * @throws {RequiredError}
         */
        revokeConsentArrangement(arrangementId: string, options?: any) {
            return ConsentApiFp(configuration).revokeConsentArrangement(arrangementId, options)(fetch, basePath);
        },
        /**
         * Update the status of a consent arrangement (e.g., suspend, resume). Based on: - UK Open Banking Account Access Consents API - Australia CDR Update Consent API 
         * @summary Update consent arrangement status
         ...
         * @throws {RequiredError}
         */
        updateConsentStatus(body: ConsentStatusUpdate, arrangementId: string, options?: any) {
            return ConsentApiFp(configuration).updateConsentStatus(body, arrangementId, options)(fetch, basePath);
        },
    };
};
...
export class ConsentApi extends BaseAPI {
     ...
     * @memberof ConsentApi
     */
    public bulkUpdateCustomerConsents(body: ArrangementsBulkupdateBody, customerId: string, options?: any) {
        return ConsentApiFp(this.configuration).bulkUpdateCustomerConsents(body, customerId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ConsentApi
     */
    public createBulkConsent(body: BulkConsentRequest, options?: any) {
        return ConsentApiFp(this.configuration).createBulkConsent(body, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ConsentApi
     */
    public createConsentArrangement(body: ConsentArrangementRequest, options?: any) {
        return ConsentApiFp(this.configuration).createConsentArrangement(body, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ConsentApi
     */
    public extendConsentDuration(body: ConsentExtensionRequest, arrangementId: string, options?: any) {
        return ConsentApiFp(this.configuration).extendConsentDuration(body, arrangementId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ConsentApi
     */
    public getConsentArrangement(arrangementId: string, options?: any) {
        return ConsentApiFp(this.configuration).getConsentArrangement(arrangementId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ConsentApi
     */
    public getConsentHistory(arrangementId: string, options?: any) {
        return ConsentApiFp(this.configuration).getConsentHistory(arrangementId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ConsentApi
     */
    public getCustomerConsentDashboard(customerId: string, options?: any) {
        return ConsentApiFp(this.configuration).getCustomerConsentDashboard(customerId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ConsentApi
     */
    public getCustomerConsents(customerId: string, status?: string, dataHolderId?: string, purpose?: string, options?: any) {
        return ConsentApiFp(this.configuration).getCustomerConsents(customerId, status, dataHolderId, purpose, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ConsentApi
     */
    public listConsentArrangements(status?: string, fromDate?: Date, toDate?: Date, options?: any) {
        return ConsentApiFp(this.configuration).listConsentArrangements(status, fromDate, toDate, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ConsentApi
     */
    public listConsentTemplates(category?: string, purpose?: string, options?: any) {
        return ConsentApiFp(this.configuration).listConsentTemplates(category, purpose, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ConsentApi
     */
    public revokeConsentArrangement(arrangementId: string, options?: any) {
        return ConsentApiFp(this.configuration).revokeConsentArrangement(arrangementId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ConsentApi
     */
    public updateConsentStatus(body: ConsentStatusUpdate, arrangementId: string, options?: any) {
        return ConsentApiFp(this.configuration).updateConsentStatus(body, arrangementId, options)(this.fetch, this.basePath);
    }
...
export const DiscoveryApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @summary Retrieve JSON Web Key Set (JWKS) containing public keys for JWT signature verification (configurable endpoint)
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
...
export const DiscoveryApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getOpenIdConfiguration(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse2004> {
...
export const OAuthApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        authorizeOAuth(clientId: string, responseType: string, scope: Array<string>, redirectUri: string, state: string, codeChallenge?: string, codeChallengeMethod?: string, prompt?: string, nonce?: string, options: any = {}): FetchArgs {
         ...
         * @throws {RequiredError}
         */
        getOAuthToken(grantType: string, code: string, redirectUri: string, clientId: string, refreshToken: string, options: any = {}): FetchArgs {
         ...
         * @throws {RequiredError}
         */
        introspectToken(token: string, options: any = {}): FetchArgs {
         ...
         * @throws {RequiredError}
         */
        oAuthPAR(body: OauthAuthBody, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
...
export const OAuthApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        authorizeOAuth(clientId: string, responseType: string, scope: Array<string>, redirectUri: string, state: string, codeChallenge?: string, codeChallengeMethod?: string, prompt?: string, nonce?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = OAuthApiFetchParamCreator(configuration).authorizeOAuth(clientId, responseType, scope, redirectUri, state, codeChallenge, codeChallengeMethod, prompt, nonce, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
         ...
         * @throws {RequiredError}
         */
        getOAuthToken(grantType: string, code: string, redirectUri: string, clientId: string, refreshToken: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse2001> {
            const localVarFetchArgs = OAuthApiFetchParamCreator(configuration).getOAuthToken(grantType, code, redirectUri, clientId, refreshToken, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getUserInfo(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse2003> {
            const localVarFetchArgs = OAuthApiFetchParamCreator(configuration).getUserInfo(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        introspectToken(token: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse2002> {
            const localVarFetchArgs = OAuthApiFetchParamCreator(configuration).introspectToken(token, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        oAuthPAR(body: OauthAuthBody, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse200> {
            const localVarFetchArgs = OAuthApiFetchParamCreator(configuration).oAuthPAR(body, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const OAuthApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        authorizeOAuth(clientId: string, responseType: string, scope: Array<string>, redirectUri: string, state: string, codeChallenge?: string, codeChallengeMethod?: string, prompt?: string, nonce?: string, options?: any) {
            return OAuthApiFp(configuration).authorizeOAuth(clientId, responseType, scope, redirectUri, state, codeChallenge, codeChallengeMethod, prompt, nonce, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Token endpoint
         ...
         * @throws {RequiredError}
         */
        getOAuthToken(grantType: string, code: string, redirectUri: string, clientId: string, refreshToken: string, options?: any) {
            return OAuthApiFp(configuration).getOAuthToken(grantType, code, redirectUri, clientId, refreshToken, options)(fetch, basePath);
        },
        /**
         * OpenID Connect UserInfo Endpoint that returns information about the authenticated user. 
         * @summary Optional OpenID Connect UserInfo Endpoint
        ...
        getUserInfo(options?: any) {
            return OAuthApiFp(configuration).getUserInfo(options)(fetch, basePath);
        },
        /**
         * Endpoint for validating and retrieving metadata about an access token. Returns information about whether the token is active, its associated client, user, scopes, and expiration details. This endpoint allows resource servers to verify tokens before granting access to protected resources. 
         * @summary Optional token introspection
         ...
         * @throws {RequiredError}
         */
        introspectToken(token: string, options?: any) {
            return OAuthApiFp(configuration).introspectToken(token, options)(fetch, basePath);
        },
        /**
         * POST version of the authorization API that initiates the authorization flow\"
         * @summary [Phase 2] PAR-based Authorization API for FI-initiated onboarding
         ...
         * @throws {RequiredError}
         */
        oAuthPAR(body: OauthAuthBody, options?: any) {
            return OAuthApiFp(configuration).oAuthPAR(body, options)(fetch, basePath);
        },
    };
};
...
export class OAuthApi extends BaseAPI {
     ...
     * @memberof OAuthApi
     */
    public authorizeOAuth(clientId: string, responseType: string, scope: Array<string>, redirectUri: string, state: string, codeChallenge?: string, codeChallengeMethod?: string, prompt?: string, nonce?: string, options?: any) {
        return OAuthApiFp(this.configuration).authorizeOAuth(clientId, responseType, scope, redirectUri, state, codeChallenge, codeChallengeMethod, prompt, nonce, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof OAuthApi
     */
    public getOAuthToken(grantType: string, code: string, redirectUri: string, clientId: string, refreshToken: string, options?: any) {
        return OAuthApiFp(this.configuration).getOAuthToken(grantType, code, redirectUri, clientId, refreshToken, options)(this.fetch, this.basePath);
    }
    ...
    public getUserInfo(options?: any) {
        return OAuthApiFp(this.configuration).getUserInfo(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof OAuthApi
     */
    public introspectToken(token: string, options?: any) {
        return OAuthApiFp(this.configuration).introspectToken(token, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof OAuthApi
     */
    public oAuthPAR(body: OauthAuthBody, options?: any) {
        return OAuthApiFp(this.configuration).oAuthPAR(body, options)(this.fetch, this.basePath);
    }

}
/**
 * PERAApi - fetch parameter creator
 * @export
 */
export const PERAApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * API that allows FIs to retrieve the status of one or more PERA Arrangements
         * @summary Get the status of a PERA arrangement
         * @param {string} arrangementId The ID of the PERA Arrangement
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getArrangementStatus(arrangementId: string, options: any = {}): FetchArgs {
            // verify required parameter 'arrangementId' is not null or undefined
            if (arrangementId === null || arrangementId === undefined) {
                throw new RequiredError('arrangementId','Required parameter arrangementId was null or undefined when calling getArrangementStatus.');
            }
            const localVarPath = `/ofxpera/arrangements/{arrangement_id}`
                .replace(`{${"arrangement_id"}}`, encodeURIComponent(String(arrangementId)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
         ...
         * @throws {RequiredError}
         */
        peraArrangementRegistration(options: any = {}): FetchArgs {
            const localVarPath = `/ofxpera/arrangements`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
/**
 * PERAApi - functional programming interface
 * @export
 */
export const PERAApiFp = function(configuration?: Configuration) {
    return {
        /**
         * API that allows FIs to retrieve the status of one or more PERA Arrangements
         * @summary Get the status of a PERA arrangement
         ...
         * @throws {RequiredError}
         */
        getArrangementStatus(arrangementId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PeraArrangement> {
            const localVarFetchArgs = PERAApiFetchParamCreator(configuration).getArrangementStatus(arrangementId, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        peraArrangementRegistration(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PeraArrangement> {
            const localVarFetchArgs = PERAApiFetchParamCreator(configuration).peraArrangementRegistration(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
/**
 * PERAApi - factory interface
 * @export
 */
export const PERAApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * API that allows FIs to retrieve the status of one or more PERA Arrangements
         * @summary Get the status of a PERA arrangement
         ...
         * @throws {RequiredError}
         */
        getArrangementStatus(arrangementId: string, options?: any) {
            return PERAApiFp(configuration).getArrangementStatus(arrangementId, options)(fetch, basePath);
        },
        /**
         * API that allows PERA Admins to register the successful creation of one or more new PERA Arrangements
         * @summary Registers a new PERA arrangement
         ...
         * @throws {RequiredError}
         */
        peraArrangementRegistration(options?: any) {
            return PERAApiFp(configuration).peraArrangementRegistration(options)(fetch, basePath);
        },
    };
};

/**
 * PERAApi - object-oriented interface
 * @export
 * @class PERAApi
 * @extends {BaseAPI}
 */
export class PERAApi extends BaseAPI {
    /**
     * API that allows FIs to retrieve the status of one or more PERA Arrangements
     * @summary Get the status of a PERA arrangement
     * @param {string} arrangementId The ID of the PERA Arrangement
     ...
     * @memberof PERAApi
     */
    public getArrangementStatus(arrangementId: string, options?: any) {
        return PERAApiFp(this.configuration).getArrangementStatus(arrangementId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof PERAApi
     */
    public peraArrangementRegistration(options?: any) {
        return PERAApiFp(this.configuration).peraArrangementRegistration(options)(this.fetch, this.basePath);
    }
